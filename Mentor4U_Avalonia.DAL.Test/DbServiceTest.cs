...
{
    private const string ConnectionStringGood =
    ...
    public async Task ConnectAsync_PositiveTest_ConnectionStringGood()
    {
        ...
        {
            await DbService<Role>.ConnectAsync(ConnectionStringGood);
        });
        Assert.Null(result);
    }
    ...
    public async Task ConnectAsync_NegativeTest_ConnectionStringEmpty()
    {
        ...
        {
            await DbService<Role>.ConnectAsync(ConnectionStringEmpty);
        });
    }
}
